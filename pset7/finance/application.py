...
def index():
    ...
    db.execute("CREATE TABLE IF NOT EXISTS portfolio(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT,user_id INTEGER, shares INTEGER, symbol TEXT, stock INTEGER)");
...
def history():
    ...
    db.execute("CREATE TABLE IF NOT EXISTS histories(id INTEGER PRIMARY KEY AUTOINCREMENT,price INTEGER, shares INTEGER, symbol TEXT)");
